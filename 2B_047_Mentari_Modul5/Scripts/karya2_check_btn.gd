...
onready var HL_Margin = $"/root/Karya2/KaryaLayer/HelperLayer/Margin"

onready var HL_Grid = $"/root/Karya2/KaryaLayer/HelperLayer/Grid"

onready var HL_Kartesian = $"/root/Karya2/KaryaLayer/HelperLayer/Kartesian"

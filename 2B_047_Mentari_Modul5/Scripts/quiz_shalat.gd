...
func _ready():
	var KL_waktuShalat = $"/root/Quiz_Shalat/karyaLayer/Jam"
	KL_waktuShalat.visible = true
	

func _draw_waktuShalat():
	var tpx = 150
	var tpy = 50
	var rb = 80
	var derajat = 30
	...
	keranjang = Dasar.ellipse(px[0]+tpx, px[1]-(tpy-50), 100, 20)
	trss = Trans.scale2(0.8, 0.5, Vector2(px[0]+tpx, px[1]-(tpy-120)))
